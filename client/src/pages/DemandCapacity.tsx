import { LayoutDashboard, PieChart, Calendar, Settings, Bell, FileText, AlertCircle, Users, Home, ListOrdered } from "lucide-react";
      ...
      <main className="flex-1 lg:ml-64">
        <header className="h-16 border-b bg-white sticky top-0 z-20 px-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-bold font-heading text-foreground">Demand vs. Capacity</h2>
          </div>
