...
import { Save, Send, Upload, CheckCircle2, Circle, XCircle, ThumbsUp, ThumbsDown, Paperclip } from "lucide-react";
...
import { mockLGateForms, lgateDefinitions, LGate, LGateRequirement, getFormStatusColor, getFormStatusLabel, RequirementInputType } from "@/lib/formData";
...
export default function LGateFormPage() {
  ...
  const { isControlTower, canEdit: userCanEdit } = useUserRole();
  ...
  return (
    <AppLayout title="Gate Progression">
